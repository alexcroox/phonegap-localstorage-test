var LocalStorageStore = {
    ...
    setup: function(setupCallback) {
        ...
        app.debug('Requesting local file system');
        window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, app.onFileSystemSuccess, app.onFileSystemFail);
    },
    // File system was created successfully
    onFileSystemSuccess: function(fileSystem) {

        app.debug('local file system init successful', fileSystem.name);

        setupCallback(true);
    },
    // Failed to setup file system
    onFileSystemFail: function(error) {
        ...
        app.debug('Error setting up filesystem', msg);
